...
from gnss_ros_package.msg import gnss_msg
import sys
...
class GPS_PARSER():
	...
	def __init__(self):
		...
		self.pub = rospy.Publisher('gps', gnss_msg, queue_size = 5)
		self.gps_data = gnss_msg()
		self.data = []
	...
	def define_lat_long_alt(self):		
		...
		self.gps_data.quality = int(self.data[6])    # Quality added.
...
if __name__ == '__main__':
	...
	if len(args) != 2:
		...
		print("Please make sure the command is of the format: roslaunch gnss_ros_package gnss_driver.launch /dev/ttyACM0")
